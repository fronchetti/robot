    ...
    async def feedback_page(request_id: str):
        ...
        with ui.row().classes('w-full place-content-center'):
            with ui.row().classes('w-6/12 p-12'):
                ...
                with ui.row().classes('w-full'):
                    satisfaction_scale = ui.radio(['Very Dissatisfied', 'Dissatisfied', 'Neutral', 'Satisfied', 'Very Satisfied'])

                with ui.row().classes('w-full'):
                    ui.html('What category of information was the most useful for this request?')

                with ui.row().classes('w-full'):
                    useful_action = ui.radio(['Chat', 'Read', 'Watch'])
                ...
                with ui.row().classes('w-full'):
                    correct_category = ui.radio(['Yes', 'No'])
